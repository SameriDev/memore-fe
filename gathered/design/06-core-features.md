# Locket Core Features

## Feature Overview

This document defines the core functionality of the Locket app, focusing on the essential features needed for a **Phase 1** implementation that delivers the core value proposition of authentic photo sharing between close friends.
...
#### User Story
> As a new user, I want to create an account using my phone number so that I can quickly join Locket and connect with friends who have my number.
...
#### User Story
> As a new user, I want to complete the initial setup process so that I can start using Locket to share photos with friends.
...
**Friend Discovery**
- Scan contacts for existing Locket users
...
#### User Story
> As a user, I want to add friends to my Locket circle so that I can share photos with people I care about.
...
#### Business Rules
- Maximum 20 friends per user (Locket's key limitation)
...
#### User Story
> As a user, I want to see notifications within the app so that I can quickly understand what's new when I open Locket.
